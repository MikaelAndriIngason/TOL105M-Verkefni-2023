...
var render = function() {
    ...
    theta[UpperArm] = Math.cos(rot * 2.0) * O1;
    theta[LowerArm] = Math.sin(rot * 2.0) * O2;
    ...
    modelViewMatrix = mult(mv, rotateY( theta[pivot] ));

    modelViewMatrix  = mult(modelViewMatrix, translate(0.0, PIVOT, 0.0));
...
function changeSpeed() {
    speed = document.getElementById("speed").value / 20;
}

function changeO1() {
    O1 = document.getElementById("theta1").value;
}

function changeO2() {
    O2 = document.getElementById("theta2").value;
}
